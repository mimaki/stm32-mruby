...
// /* PLL_VCO = (HSE_VALUE or HSI_VALUE / PLL_M) * PLL_N */
// base = 1,000,000 1MHz
// 4032 = (12,000,000/12)*336
#define PLL_M   (HSE_VALUE / 1000000)   /* 12 Possible value 0 and 63 */
#define PLL_N   336                     /* 336 Possible value 192 and 432 */
...
/* ex. to have SYSCLK @  120 MHz
     168MHz  SYSCLK = 168M PLLVCO / 1 PLL_P
              = ((12M HSE_VALUE / 20 PLL_M) * 280 PLL_N) / 1 PLL_P
   */

/* 172,000,000 PLLI2S_VCO = (168M HSE_VALUE Or HSI_VALUE / 20 PLL_M) * PLLI2S_N
