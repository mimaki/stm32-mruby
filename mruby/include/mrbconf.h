...
#define MRB_FUNCALL_ARGC_MAX 6 //16

/* number of object per heap page */
#define MRB_HEAP_PAGE_SIZE 32 //1024

/* use segmented list for IV table */
#define MRB_USE_IV_SEGLIST

/* initial size for IV khash; ignored when MRB_USE_IV_SEGLIST is set */
#define MRB_IVHASH_INIT_SIZE 2 //8

/* initial size for IREP array */
//#define MRB_IREP_ARRAY_INIT_SIZE (256u)

/* default size of khash table bucket */
#define KHASH_DEFAULT_SIZE 2 //32

/* allocated memory address alignment */
//#define POOL_ALIGNMENT 4

/* page size of memory pool */
#define POOL_PAGE_SIZE 256 //16000
