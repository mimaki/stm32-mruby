...
/*
 ...
 | PD10 <-> FSMC_D15 | PE6  <-> FSMC_A22  | PF12 <-> FSMC_A6 | PG9 <-> FSMC_NE2 -> PD7 <-> FSMC_NE1|
...
/*-- FSMC Configuration ------------------------------------------------------*/
  p.FSMC_AddressSetupTime = 5;//9;
  p.FSMC_AddressHoldTime = 0;//9; //0 for SRAM
  p.FSMC_DataSetupTime = 3;//9;
  p.FSMC_BusTurnAroundDuration = 0;// 9;
